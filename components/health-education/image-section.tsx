      ...
      const mockImages: HealthImage[] = [
        {
          ...
          description: "A variety of colorful, nutritious meals prepared in advance for the week, featuring lean proteins, whole grains, and fresh vegetables.",
        ...
        },
        {
          ...
          description: "Essential yoga poses demonstrated with proper form and alignment, perfect for those starting their yoga journey.",
          imageUrl: getPlaceholderImage(400, 300),
          source: "Yoga Journal"
        },
        {
          ...
          description: "Comprehensive diagram showing detailed views of the human muscular and skeletal systems with labeled parts.",
          imageUrl: getPlaceholderImage(400, 300),
          source: "Medical Encyclopedia"
        }
      ]
      
      setImages(mockImages.filter(image => 
          ...
          images.map(image => (
            <Dialog key={image.id}>
              ...
              <DialogContent className="sm:max-w-[675px]">
                ...
                <p className="text-sm text-muted-foreground mt-4">{image.description}</p>
                <p className="text-sm text-muted-foreground mt-2">Source: {image.source}</p>
              </DialogContent>
            </Dialog>
          ))
        )}
