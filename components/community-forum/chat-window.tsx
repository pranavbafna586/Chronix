...
import { ArrowLeft, Paperclip, Mic, Send, Phone, Video, MoreVertical, Smile } from 'lucide-react'
...
export function ChatWindow({ contact, onBack }: ChatWindowProps) {
  ...
  return (
    <div className="flex flex-col h-full max-w-lg mx-auto"> {/* Added max-w-lg and mx-auto */}
